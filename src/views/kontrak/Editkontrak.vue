...
<div class="card shadow mt-3">
  ...
  <div class="col-md-6">
    ...
    v-model="contractcourses.mahasiswa_id" />
  ...
  <div class="col-md-6">
    ...
    <input type="text" class="form-control" id="inputEmail4" 
    v-model="contractcourses.semester_id" />
...
export default {
  setup() {
    ...
    onMounted(()=>{
      axios.get(`http://127.0.0.1:8000/api/contractcourses/${route.params.id}`)
      .then(response => {
    ...
    function update(){
      ...
      axios.put(`http://127.0.0.1:8000/api/contractcourses/${route.params.id}`, {
